    ...
    palettes: {
        ...
        reactkr: {
            ...
            colors: [
                ...
                '#6b5b8f', // 쿠로카 퍼플: 7e7291에서 게임적 허용으로 채도 고도
                '#168f43', // 마요 그린

                '#f6d3ff', // 키라 핑크
                '#1a1717', // 텐텐 블랙
                '#6a8bab', // 라떼 블루: 7f97ac에서 게임적 허용으로 채도 고도
                '#ffe44d', // 나오 옐로: fff3b2에서 게임적 허용으로 채도가 높아졌음
                '#f27127', // 무무 오렌지
                
                '#fff8d9 ', // 데스와 옐로
                '#c9a898', // 스야 브라운: c1b2a8에서 게임적 허용으로 채도 고도
                '#f08fab', // 쵸케 핑크: ffd8d9에서 게임적 허용으로 진해졌음
            ],
            emojis: ['🍎', '☁️', '🔮', '🍀',
                '💖', '🍙', '🐯', '🎫', '🧡',
                '🏰', '🐈', '🦷'],
